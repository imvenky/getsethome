<?php
	...
	$commonBtnText 	= "Belong Here";
	$commonRupees 	= "&#8377;";
	$strHelpLine   	= "8080 900 300";

	// switch ($p2) {
	// 	case 'listing':
	// 		require_once("listing.gsh");
	// 		break;
	// 	case '':
	// 		header("Location:/");
	// 		break;
	...
	$json_filters		= file_get_contents('./data/json/property_filter.json');
	$array_filters 		= json_decode($json_filters, true);
	$array_filters 		= $array_filters["arrPropertyFilters"];
?>